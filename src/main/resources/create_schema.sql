...
-- Tue 21 Aug 2018 04:22:31 PM MDT
...
CREATE TABLE IF NOT EXISTS `refactoring_analysis`.`refactoring` (
  ...
  CONSTRAINT `fk_refactoring_refactoring_commit1`
    ...
    REFERENCES `refactoring_analysis`.`refactoring_commit` (`id` , `project_id` , `commit_hash`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `refactoring_analysis`.`refactoring_region` (
  ...
  CONSTRAINT `fk_refactoring_region_refactoring1`
    ...
    REFERENCES `refactoring_analysis`.`refactoring` (`id` , `refactoring_commit_id` , `commit_hash` , `project_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
